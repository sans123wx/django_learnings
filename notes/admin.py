...
class NotesAdmin(admin.ModelAdmin):
    fields = ('date','类别','型号','故障描述','价格','数量','教室','方式','售后','报账时间','报账','scraped','owner')
    list_display = ('date','类别','型号','故障描述','价格','数量','合计','教室','方式','售后','报账时间','报账','owner','scraped')
#    list_editable = ('owner',)
...
class Report_timeAdmin(admin.ModelAdmin):
    list_display = ('id','title','detail','report_time','customer')
